...
const ru: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "Случайный вызов",
  "challenge.subtitle": "Выпадает набор правил — билд собираешь сам",
  "challenge.rollButton": "Бросить вызов",
  "challenge.difficulty.easy": "Лёгкий",
  "challenge.difficulty.medium": "Средний",
  "challenge.difficulty.hard": "Сложный",
  "challenge.difficulty.extreme": "Экстрим",
  "challenge.difficultyHint.easy": "Класс, аскенданси и основной скилл. Остальное на твоё усмотрение.",
  "challenge.difficultyHint.medium": "Добавляет обязательное оружие, обязательный уникум и запрет скиллов передвижения.",
  "challenge.difficultyHint.hard": "Добавляет кистоун, запрещает прочие уникумы и два саппорт-камня.",
  "challenge.difficultyHint.extreme": "Всё из «Сложного» плюс два жестоких правила.",
  "challenge.seedLabel": "Сид",
  "challenge.seedPlaceholder": "Вставьте сид, напр. hard:8F3K22",
  "challenge.loadSeed": "Загрузить сид",
  "challenge.invalidSeed": "Неверный сид. Ожидается вид hard:8F3K22.",
  "challenge.badge": "Вызов",
  "challenge.copySeed": "Скопировать сид",
  "challenge.rule.class": "Играй за {{className}} — аскенданси {{ascendancy}}",
  "challenge.rule.skill": "Основной скилл — {{skill}}",
  "challenge.rule.level": "Достигни {{level}} уровня",
  "challenge.rule.weapon": "Используй: {{weapon}}",
  "challenge.rule.unarmed": "Сражайся без оружия",
  "challenge.rule.unique": "Надень {{unique}} ({{slot}})",
  "challenge.rule.keystone": "Возьми кистоун {{keystone}}",
  "challenge.rule.banMovement": "Без скиллов передвижения (Leap Slam, Dash, Flame Dash и т. п.)",
  "challenge.rule.banOtherUniques": "Никаких уникумов, кроме {{unique}}",
  "challenge.rule.banAllUniques": "Никаких уникальных предметов",
  "challenge.rule.banSupports": "Запрещённые саппорт-камни: {{supports}}",
  "challenge.weapon.any": "любое оружие",
  "challenge.weapon.bow": "Лук",
  "challenge.weapon.wand": "Жезл",
  "challenge.weapon.sceptre": "Скипетр",
  "challenge.weapon.staff": "Посох",
  "challenge.weapon.dagger": "Кинжал",
  "challenge.weapon.claw": "Коготь",
  "challenge.weapon.oneHandSword": "Одноручный меч",
  "challenge.weapon.twoHandSword": "Двуручный меч",
  "challenge.weapon.oneHandAxe": "Одноручный топор",
  "challenge.weapon.twoHandAxe": "Двуручный топор",
  "challenge.weapon.oneHandMace": "Одноручная булава",
  "challenge.weapon.twoHandMace": "Двуручная булава",
  "challenge.weapon.unarmed": "Без оружия",
  "challenge.extra.ssf": "Solo Self-Found — без торговли с игроками",
  "challenge.extra.noDeathsUntilMaps": "Ни одной смерти до конца 10-го акта",
  "challenge.extra.noLifeFlask": "Без фляг здоровья",
  "challenge.extra.singleFlask": "Только одна фляга одновременно",
  "challenge.extra.maxFourLink": "Основной скилл — максимум 4-линк",
  "challenge.extra.noRareJewels": "Без редких самоцветов — только магические и ниже",
  "challenge.extra.budgetOneDivine": "Общий бюджет снаряжения: 1 Divine Orb",
  "challenge.extra.noLifeOnGear": "Никаких модификаторов максимума здоровья на снаряжении",
  "challenge.extra.noVendorRecipes": "Без рецептов торговцев",
  "challenge.extra.noSecondWeaponSet": "Без второго набора оружия",
  "challenge.extra.noAuras": "Без аур, резервирующих здоровье или ману",
  "challenge.extra.noMovementSpeedBoots": "Без скорости передвижения на ботинках",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "Вызов · {{difficulty}}",
  "challenge.tagline": "Вызов {{difficulty}} · сид {{seed}} · правил: {{count}}",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "Вызов {{difficulty}} · правил соблюсти: {{count}}",
  "challenge.seedNote": "Сид {{code}} — поделись, чтобы дать тот же вызов другому",
  "challenge.keystoneInstructions": "Обязательный кистоун. На дереве он отмечен — путь к нему выбираешь сам.",
  "challenge.treeSpecTitle": "Предлагаемый путь · {{points}} оч.",
  "challenge.requiredSetup": "Требуется вызовом",
  "challenge.gemNotes": "На этой сложности саппорт-камни не ограничены",
  "challenge.gearUniqueNotes": "Обязательный предмет — без него вызов не засчитан",
  "challenge.gearAllSlots": "Все слоты",
  "challenge.invalidCode": "Неверный код вызова: {{code}}",
  "challenge.card.ascendancy": "Аскенданси",
  "challenge.card.ascendancyNote": "Выпала в вызове",
  "challenge.card.mainSkill": "Основной скилл",
  "challenge.card.mainSkillNote": "Весь урон должен идти от этого скилла",
  "challenge.card.seed": "Сид",
  "challenge.card.seedNote": "Тот же сид — тот же вызов",
  "challenge.card.keystone": "Кистоун",
  "challenge.suggestedSetup": "Предложено вызовом",
  "challenge.treePlanTitle": "Предлагаемый путь пассивок",
  "challenge.treePlanNote": "{{points}} из {{available}} очков, спланировано под твой скилл: {{highlights}}. Меняй свободно — правилом являются только обязательные узлы.",
  "challenge.gearBaseNotes": "Предлагаемая база · {{defence}} · требует {{level}} ур.",
  "challenge.gearBaseNotesPlain": "Предлагаемая база · требует {{level}} ур.",
  "challenge.stat.life": "Максимум здоровья",
  "challenge.stat.resistances": "Сопротивления стихиям",
  "challenge.card.treePoints": "Очки пассивок",
  "challenge.card.treePointsNote": "Предлагаемое распределение — правило только обязательные узлы",
  "challenge.group.movement": "Передвижение",
  "challenge.group.aura": "Аура",
  "challenge.gemSuggestedNotes": "Предлагаемый вспомогательный камень — меняй свободно",
  "challenge.gemLinksNotes": "{{count}} саппортов, которые реально работают с этим скиллом",
  "challenge.group.main": "Основные связки",
  "challenge.group.guard": "Защитный скилл",
  "challenge.group.curse": "Проклятие",
  "challenge.gemGroupSlotNotes": "Предложено для слота {{slot}} — меняй свободно",
};
