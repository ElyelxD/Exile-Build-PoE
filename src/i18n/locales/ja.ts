...
const ja: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "ランダムチャレンジ",
  "challenge.subtitle": "ルールを引いて自分で組み立てる",
  "challenge.rollButton": "チャレンジを引く",
  "challenge.difficulty.easy": "イージー",
  "challenge.difficulty.medium": "ミディアム",
  "challenge.difficulty.hard": "ハード",
  "challenge.difficulty.extreme": "エクストリーム",
  "challenge.difficultyHint.easy": "クラス・アセンダンシー・メインスキル。あとは自由。",
  "challenge.difficultyHint.medium": "指定武器・指定ユニークが追加され、移動スキルが禁止されます。",
  "challenge.difficultyHint.hard": "キーストーンが追加され、他のユニークとサポートジェム2つが禁止されます。",
  "challenge.difficultyHint.extreme": "ハードの全ルールに加え、過酷な追加ルールが2つ。",
  "challenge.seedLabel": "シード",
  "challenge.seedPlaceholder": "シードを貼り付け（例: hard:8F3K22）",
  "challenge.loadSeed": "シードを読み込む",
  "challenge.invalidSeed": "シードが無効です。hard:8F3K22 のような形式が必要です。",
  "challenge.badge": "チャレンジ",
  "challenge.copySeed": "シードをコピー",
  "challenge.rule.class": "{{className}} をプレイ — アセンダンシー {{ascendancy}}",
  "challenge.rule.skill": "メインスキルは {{skill}}",
  "challenge.rule.level": "レベル {{level}} に到達",
  "challenge.rule.weapon": "{{weapon}} を使用",
  "challenge.rule.unarmed": "素手で戦う — 武器の装備禁止",
  "challenge.rule.unique": "{{unique}} を装備（{{slot}}）",
  "challenge.rule.keystone": "キーストーン {{keystone}} を取得",
  "challenge.rule.banMovement": "移動スキル禁止（Leap Slam・Dash・Flame Dash など）",
  "challenge.rule.banOtherUniques": "{{unique}} 以外のユニーク禁止",
  "challenge.rule.banAllUniques": "ユニーク装備は一切禁止",
  "challenge.rule.banSupports": "禁止サポートジェム: {{supports}}",
  "challenge.weapon.any": "任意の武器",
  "challenge.weapon.bow": "弓",
  "challenge.weapon.wand": "ワンド",
  "challenge.weapon.sceptre": "セプター",
  "challenge.weapon.staff": "スタッフ",
  "challenge.weapon.dagger": "ダガー",
  "challenge.weapon.claw": "クロー",
  "challenge.weapon.oneHandSword": "片手剣",
  "challenge.weapon.twoHandSword": "両手剣",
  "challenge.weapon.oneHandAxe": "片手斧",
  "challenge.weapon.twoHandAxe": "両手斧",
  "challenge.weapon.oneHandMace": "片手メイス",
  "challenge.weapon.twoHandMace": "両手メイス",
  "challenge.weapon.unarmed": "素手",
  "challenge.extra.ssf": "Solo Self-Found — 他プレイヤーとの取引禁止",
  "challenge.extra.noDeathsUntilMaps": "Act 10 クリアまで死亡ゼロ",
  "challenge.extra.noLifeFlask": "ライフフラスコの装備禁止",
  "challenge.extra.singleFlask": "フラスコは同時に1つのみ",
  "challenge.extra.maxFourLink": "メインスキルは4リンクまで",
  "challenge.extra.noRareJewels": "レアジュエル禁止 — マジック以下のみ",
  "challenge.extra.budgetOneDivine": "装備予算は合計 Divine Orb 1個",
  "challenge.extra.noLifeOnGear": "装備に最大ライフ modifier を付けない",
  "challenge.extra.noVendorRecipes": "ベンダーレシピ禁止",
  "challenge.extra.noSecondWeaponSet": "セカンドウェポンセット禁止",
  "challenge.extra.noAuras": "ライフ/マナを予約するオーラ禁止",
  "challenge.extra.noMovementSpeedBoots": "ブーツに移動速度を付けない",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "チャレンジ · {{difficulty}}",
  "challenge.tagline": "{{difficulty}}チャレンジ · シード {{seed}} · ルール {{count}} 件",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "{{difficulty}}チャレンジ · 守るべきルール {{count}} 件",
  "challenge.seedNote": "シード {{code}} — 共有すれば同じチャレンジを渡せます",
  "challenge.keystoneInstructions": "必須キーストーン。ツリーでは取得済みとして表示されます — 経路の設計は自由です。",
  "challenge.treeSpecTitle": "推奨パス · {{points}}ポイント",
  "challenge.requiredSetup": "チャレンジの必須要件",
  "challenge.gemNotes": "この難易度ではサポートジェムの制限はありません",
  "challenge.gearUniqueNotes": "必須アイテム — 装備しなければチャレンジは無効",
  "challenge.gearAllSlots": "全スロット",
  "challenge.invalidCode": "無効なチャレンジコード: {{code}}",
  "challenge.card.ascendancy": "アセンダンシー",
  "challenge.card.ascendancyNote": "チャレンジで抽選",
  "challenge.card.mainSkill": "メインスキル",
  "challenge.card.mainSkillNote": "ダメージはすべてこのスキルから出すこと",
  "challenge.card.seed": "シード",
  "challenge.card.seedNote": "同じシードなら同じチャレンジ",
  "challenge.card.keystone": "キーストーン",
  "challenge.suggestedSetup": "チャレンジの推奨",
  "challenge.treePlanTitle": "推奨パッシブパス",
  "challenge.treePlanNote": "{{available}}ポイント中{{points}}をスキルに合わせて自動設計: {{highlights}}。自由に変更可 — ルールは必須ノードのみ。",
  "challenge.gearBaseNotes": "推奨ベース · {{defence}} · レベル{{level}}必要",
  "challenge.gearBaseNotesPlain": "推奨ベース · レベル{{level}}必要",
  "challenge.stat.life": "最大ライフ",
  "challenge.stat.resistances": "元素耐性",
  "challenge.card.treePoints": "パッシブポイント",
  "challenge.card.treePointsNote": "推奨配分 — ルールは必須ノードのみ",
  "challenge.group.movement": "移動",
  "challenge.group.aura": "オーラ",
  "challenge.gemSuggestedNotes": "推奨ユーティリティジェム — 自由に変更可",
  "challenge.gemLinksNotes": "このスキルに正しくリンクするサポート{{count}}個",
  "challenge.group.main": "メインリンク",
  "challenge.group.guard": "ガード",
  "challenge.group.curse": "カース",
  "challenge.gemGroupSlotNotes": "{{slot}} 用の推奨 — 自由に組み替え可",
};
