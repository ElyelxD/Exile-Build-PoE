...
const th: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "ชาเลนจ์สุ่ม",
  "challenge.subtitle": "สุ่มชุดกฎแล้วสร้างบิลด์เอง",
  "challenge.rollButton": "สุ่มชาเลนจ์",
  "challenge.difficulty.easy": "ง่าย",
  "challenge.difficulty.medium": "ปานกลาง",
  "challenge.difficulty.hard": "ยาก",
  "challenge.difficulty.extreme": "สุดขีด",
  "challenge.difficultyHint.easy": "คลาส แอสเซนแดนซี และสกิลหลัก ที่เหลือแล้วแต่คุณ",
  "challenge.difficultyHint.medium": "เพิ่มอาวุธบังคับ ไอเทมยูนีคบังคับ และห้ามสกิลเคลื่อนที่",
  "challenge.difficultyHint.hard": "เพิ่มคีย์สโตน ห้ามยูนีคอื่น และห้ามซัพพอร์ตเจ็ม 2 อัน",
  "challenge.difficultyHint.extreme": "ทุกอย่างจากระดับยาก บวกกฎโหดอีก 2 ข้อ",
  "challenge.seedLabel": "ซีด",
  "challenge.seedPlaceholder": "วางซีด เช่น hard:8F3K22",
  "challenge.loadSeed": "โหลดซีด",
  "challenge.invalidSeed": "ซีดไม่ถูกต้อง ต้องเป็นรูปแบบ hard:8F3K22",
  "challenge.badge": "ชาเลนจ์",
  "challenge.copySeed": "คัดลอกซีด",
  "challenge.rule.class": "เล่น {{className}} — แอสเซนแดนซี {{ascendancy}}",
  "challenge.rule.skill": "สกิลหลักต้องเป็น {{skill}}",
  "challenge.rule.level": "ไปให้ถึงเลเวล {{level}}",
  "challenge.rule.weapon": "ใช้ {{weapon}}",
  "challenge.rule.unarmed": "สู้ด้วยมือเปล่า — ห้ามใส่อาวุธ",
  "challenge.rule.unique": "สวมใส่ {{unique}} ({{slot}})",
  "challenge.rule.keystone": "ลงคีย์สโตน {{keystone}}",
  "challenge.rule.banMovement": "ห้ามสกิลเคลื่อนที่ (Leap Slam, Dash, Flame Dash ฯลฯ)",
  "challenge.rule.banOtherUniques": "ห้ามไอเทมยูนีคอื่นนอกจาก {{unique}}",
  "challenge.rule.banAllUniques": "ห้ามไอเทมยูนีคทั้งหมด",
  "challenge.rule.banSupports": "ซัพพอร์ตเจ็มที่ห้าม: {{supports}}",
  "challenge.weapon.any": "อาวุธใดก็ได้",
  "challenge.weapon.bow": "ธนู",
  "challenge.weapon.wand": "ว่อนด์",
  "challenge.weapon.sceptre": "คทา",
  "challenge.weapon.staff": "ไม้เท้า",
  "challenge.weapon.dagger": "มีดสั้น",
  "challenge.weapon.claw": "กรงเล็บ",
  "challenge.weapon.oneHandSword": "ดาบมือเดียว",
  "challenge.weapon.twoHandSword": "ดาบสองมือ",
  "challenge.weapon.oneHandAxe": "ขวานมือเดียว",
  "challenge.weapon.twoHandAxe": "ขวานสองมือ",
  "challenge.weapon.oneHandMace": "กระบองมือเดียว",
  "challenge.weapon.twoHandMace": "กระบองสองมือ",
  "challenge.weapon.unarmed": "มือเปล่า",
  "challenge.extra.ssf": "Solo Self-Found — ห้ามเทรดกับผู้เล่นอื่น",
  "challenge.extra.noDeathsUntilMaps": "ห้ามตายจนกว่าจะจบ Act 10",
  "challenge.extra.noLifeFlask": "ห้ามใส่ขวดยาเลือด",
  "challenge.extra.singleFlask": "ใส่ขวดยาได้ครั้งละ 1 ขวดเท่านั้น",
  "challenge.extra.maxFourLink": "สกิลหลักได้แค่ 4-link",
  "challenge.extra.noRareJewels": "ห้ามจิวเวลแรร์ — ใช้ได้แค่เมจิกหรือต่ำกว่า",
  "challenge.extra.budgetOneDivine": "งบไอเทมรวม 1 Divine Orb",
  "challenge.extra.noLifeOnGear": "ห้ามมี Maximum Life บนไอเทมใด ๆ",
  "challenge.extra.noVendorRecipes": "ห้ามใช้สูตรเวนเดอร์",
  "challenge.extra.noSecondWeaponSet": "ห้ามใช้ชุดอาวุธที่สอง",
  "challenge.extra.noAuras": "ห้ามออร่าที่จองเลือดหรือมานา",
  "challenge.extra.noMovementSpeedBoots": "ห้ามมี Movement Speed บนรองเท้า",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "ชาเลนจ์ · {{difficulty}}",
  "challenge.tagline": "ชาเลนจ์ {{difficulty}} · ซีด {{seed}} · {{count}} กฎ",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "ชาเลนจ์ {{difficulty}} · ต้องทำตาม {{count}} กฎ",
  "challenge.seedNote": "ซีด {{code}} — แชร์เพื่อให้คนอื่นได้ชาเลนจ์เดียวกัน",
  "challenge.keystoneInstructions": "คีย์สโตนบังคับ ต้นไม้แสดงว่าลงไว้แล้ว — เส้นทางไปหาแล้วแต่คุณ",
  "challenge.treeSpecTitle": "เส้นทางที่แนะนำ · {{points}} แต้ม",
  "challenge.requiredSetup": "บังคับโดยชาเลนจ์",
  "challenge.gemNotes": "ระดับนี้ไม่จำกัดซัพพอร์ตเจ็ม",
  "challenge.gearUniqueNotes": "ไอเทมบังคับ — ถ้าไม่มีถือว่าชาเลนจ์เป็นโมฆะ",
  "challenge.gearAllSlots": "ทุกช่อง",
  "challenge.invalidCode": "โค้ดชาเลนจ์ไม่ถูกต้อง: {{code}}",
  "challenge.card.ascendancy": "แอสเซนแดนซี",
  "challenge.card.ascendancyNote": "สุ่มโดยชาเลนจ์",
  "challenge.card.mainSkill": "สกิลหลัก",
  "challenge.card.mainSkillNote": "ดาเมจทั้งหมดต้องมาจากสกิลนี้",
  "challenge.card.seed": "ซีด",
  "challenge.card.seedNote": "ซีดเดียวกัน ชาเลนจ์เดียวกัน",
  "challenge.card.keystone": "คีย์สโตน",
  "challenge.suggestedSetup": "ข้อเสนอจากชาเลนจ์",
  "challenge.treePlanTitle": "เส้นทางพาสซีฟที่แนะนำ",
  "challenge.treePlanNote": "{{points}} จาก {{available}} แต้ม วางแผนรอบสกิลของคุณ: {{highlights}} ปรับได้อิสระ — มีแค่โหนดบังคับที่เป็นกฎ",
  "challenge.gearBaseNotes": "เบสที่แนะนำ · {{defence}} · ต้องการเลเวล {{level}}",
  "challenge.gearBaseNotesPlain": "เบสที่แนะนำ · ต้องการเลเวล {{level}}",
  "challenge.stat.life": "เลือดสูงสุด",
  "challenge.stat.resistances": "ต้านทานธาตุ",
  "challenge.card.treePoints": "แต้มพาสซีฟ",
  "challenge.card.treePointsNote": "การลงแต้มที่แนะนำ — มีแค่โหนดบังคับที่เป็นกฎ",
  "challenge.group.movement": "การเคลื่อนที่",
  "challenge.group.aura": "ออร่า",
  "challenge.gemSuggestedNotes": "เจ็มยูทิลิตี้ที่แนะนำ — เปลี่ยนได้อิสระ",
  "challenge.gemLinksNotes": "ซัพพอร์ต {{count}} อันที่ลิงก์กับสกิลนี้ได้จริง",
  "challenge.group.main": "ลิงก์หลัก",
  "challenge.group.guard": "การ์ด",
  "challenge.group.curse": "คำสาป",
  "challenge.gemGroupSlotNotes": "แนะนำสำหรับ {{slot}} — จัดใหม่ได้อิสระ",
};
