...
const de: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "Zufalls-Challenge",
  "challenge.subtitle": "Wirfle ein Regelwerk und baue selbst",
  "challenge.rollButton": "Challenge würfeln",
  "challenge.difficulty.easy": "Leicht",
  "challenge.difficulty.medium": "Mittel",
  "challenge.difficulty.hard": "Schwer",
  "challenge.difficulty.extreme": "Extrem",
  "challenge.difficultyHint.easy": "Klasse, Aufstieg und Hauptskill. Der Rest liegt bei dir.",
  "challenge.difficultyHint.medium": "Fügt Pflichtwaffe, Pflicht-Unique hinzu und verbietet Bewegungsskills.",
  "challenge.difficultyHint.hard": "Fügt einen Keystone hinzu, verbietet alle anderen Uniques und zwei Support-Gems.",
  "challenge.difficultyHint.extreme": "Alles aus Schwer plus zwei brutale Zusatzregeln.",
  "challenge.seedLabel": "Seed",
  "challenge.seedPlaceholder": "Seed einfügen, z. B. hard:8F3K22",
  "challenge.loadSeed": "Seed laden",
  "challenge.invalidSeed": "Ungültiger Seed. Erwartet wird z. B. hard:8F3K22.",
  "challenge.badge": "Challenge",
  "challenge.copySeed": "Seed kopieren",
  "challenge.rule.class": "Spiele {{className}} — Aufstieg {{ascendancy}}",
  "challenge.rule.skill": "Hauptskill muss {{skill}} sein",
  "challenge.rule.level": "Erreiche Level {{level}}",
  "challenge.rule.weapon": "Benutze {{weapon}}",
  "challenge.rule.unarmed": "Kämpfe unbewaffnet — keine Waffe ausgerüstet",
  "challenge.rule.unique": "Rüste {{unique}} aus ({{slot}})",
  "challenge.rule.keystone": "Weise den Keystone {{keystone}} zu",
  "challenge.rule.banMovement": "Keine Bewegungsskills (kein Leap Slam, Dash, Flame Dash...)",
  "challenge.rule.banOtherUniques": "Keine Unique-Items außer {{unique}}",
  "challenge.rule.banAllUniques": "Keinerlei Unique-Items",
  "challenge.rule.banSupports": "Verbotene Support-Gems: {{supports}}",
  "challenge.weapon.any": "beliebige Waffe",
  "challenge.weapon.bow": "Bogen",
  "challenge.weapon.wand": "Zauberstab",
  "challenge.weapon.sceptre": "Zepter",
  "challenge.weapon.staff": "Stab",
  "challenge.weapon.dagger": "Dolch",
  "challenge.weapon.claw": "Klaue",
  "challenge.weapon.oneHandSword": "Einhandschwert",
  "challenge.weapon.twoHandSword": "Zweihandschwert",
  "challenge.weapon.oneHandAxe": "Einhandaxt",
  "challenge.weapon.twoHandAxe": "Zweihandaxt",
  "challenge.weapon.oneHandMace": "Einhandstreitkolben",
  "challenge.weapon.twoHandMace": "Zweihandstreitkolben",
  "challenge.weapon.unarmed": "Unbewaffnet",
  "challenge.extra.ssf": "Solo Self-Found — kein Handel mit anderen Spielern",
  "challenge.extra.noDeathsUntilMaps": "Kein einziger Tod bis zum Ende von Akt 10",
  "challenge.extra.noLifeFlask": "Keine Lebensfläschchen ausgerüstet",
  "challenge.extra.singleFlask": "Nur ein Fläschchen gleichzeitig",
  "challenge.extra.maxFourLink": "Hauptskill maximal 4-Link",
  "challenge.extra.noRareJewels": "Keine seltenen Juwelen — nur magisch oder schlechter",
  "challenge.extra.budgetOneDivine": "Gesamtbudget für Ausrüstung: 1 Divine Orb",
  "challenge.extra.noLifeOnGear": "Kein Modifikator für maximales Leben auf der Ausrüstung",
  "challenge.extra.noVendorRecipes": "Keine Händlerrezepte",
  "challenge.extra.noSecondWeaponSet": "Kein zweites Waffenset",
  "challenge.extra.noAuras": "Keine Auren, die Leben oder Mana reservieren",
  "challenge.extra.noMovementSpeedBoots": "Keine Laufgeschwindigkeit auf den Stiefeln",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "Challenge · {{difficulty}}",
  "challenge.tagline": "{{difficulty}}-Challenge · Seed {{seed}} · {{count}} Regeln",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "{{difficulty}}-Challenge · {{count}} Regeln einzuhalten",
  "challenge.seedNote": "Seed {{code}} — teile ihn, um dieselbe Challenge weiterzugeben",
  "challenge.keystoneInstructions": "Pflicht-Keystone. Der Baum zeigt ihn zugewiesen — den Weg dorthin planst du.",
  "challenge.treeSpecTitle": "Vorgeschlagener Pfad · {{points}} Pkt.",
  "challenge.requiredSetup": "Von der Challenge gefordert",
  "challenge.gemNotes": "Keine Support-Gem-Beschränkungen in dieser Schwierigkeit",
  "challenge.gearUniqueNotes": "Pflicht-Item — ohne es zählt die Challenge nicht",
  "challenge.gearAllSlots": "Alle Slots",
  "challenge.invalidCode": "Ungültiger Challenge-Code: {{code}}",
  "challenge.card.ascendancy": "Aufstieg",
  "challenge.card.ascendancyNote": "Von der Challenge gewürfelt",
  "challenge.card.mainSkill": "Hauptskill",
  "challenge.card.mainSkillNote": "Dein gesamter Schaden muss aus diesem Skill kommen",
  "challenge.card.seed": "Seed",
  "challenge.card.seedNote": "Gleicher Seed, gleiche Challenge",
  "challenge.card.keystone": "Keystone",
  "challenge.suggestedSetup": "Von der Challenge vorgeschlagen",
  "challenge.treePlanTitle": "Vorgeschlagener Passivpfad",
  "challenge.treePlanNote": "{{points}} von {{available}} Punkten, um deinen Skill herum geplant: {{highlights}}. Ändere frei — nur die Pflichtknoten sind Regel.",
  "challenge.gearBaseNotes": "Vorgeschlagene Basis · {{defence}} · benötigt Level {{level}}",
  "challenge.gearBaseNotesPlain": "Vorgeschlagene Basis · benötigt Level {{level}}",
  "challenge.stat.life": "Maximales Leben",
  "challenge.stat.resistances": "Elementarwiderstände",
  "challenge.card.treePoints": "Passivpunkte",
  "challenge.card.treePointsNote": "Vorgeschlagene Verteilung — nur die Pflichtknoten sind Regel",
  "challenge.group.movement": "Bewegung",
  "challenge.group.aura": "Aura",
  "challenge.gemSuggestedNotes": "Vorgeschlagener Utility-Gem — frei austauschbar",
  "challenge.gemLinksNotes": "{{count}} Supports, die legal mit diesem Skill verlinkt sind",
  "challenge.group.main": "Hauptlinks",
  "challenge.group.guard": "Schutz",
  "challenge.group.curse": "Fluch",
  "challenge.gemGroupSlotNotes": "Vorschlag für {{slot}} — frei umstellbar",
};
