...
const zhCN: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "随机挑战",
  "challenge.subtitle": "抽取一套规则，自己完成构筑",
  "challenge.rollButton": "抽取挑战",
  "challenge.difficulty.easy": "简单",
  "challenge.difficulty.medium": "中等",
  "challenge.difficulty.hard": "困难",
  "challenge.difficulty.extreme": "极限",
  "challenge.difficultyHint.easy": "职业、升华和主技能。其余随你。",
  "challenge.difficultyHint.medium": "增加指定武器、指定传奇装备，并禁用位移技能。",
  "challenge.difficultyHint.hard": "增加一个核心天赋，禁用其他传奇装备和两个辅助宝石。",
  "challenge.difficultyHint.extreme": "困难的全部规则，外加两条残酷的额外规则。",
  "challenge.seedLabel": "种子",
  "challenge.seedPlaceholder": "粘贴种子，例如 hard:8F3K22",
  "challenge.loadSeed": "载入种子",
  "challenge.invalidSeed": "种子无效，格式应为 hard:8F3K22。",
  "challenge.badge": "挑战",
  "challenge.copySeed": "复制种子",
  "challenge.rule.class": "使用 {{className}} — 升华 {{ascendancy}}",
  "challenge.rule.skill": "主技能必须是 {{skill}}",
  "challenge.rule.level": "达到 {{level}} 级",
  "challenge.rule.weapon": "使用 {{weapon}}",
  "challenge.rule.unarmed": "徒手战斗 — 不装备武器",
  "challenge.rule.unique": "装备 {{unique}}（{{slot}}）",
  "challenge.rule.keystone": "点出核心天赋 {{keystone}}",
  "challenge.rule.banMovement": "禁用位移技能（跳斩、冲刺、烈焰冲刺等）",
  "challenge.rule.banOtherUniques": "除 {{unique}} 外禁用传奇装备",
  "challenge.rule.banAllUniques": "完全禁用传奇装备",
  "challenge.rule.banSupports": "禁用辅助宝石：{{supports}}",
  "challenge.weapon.any": "任意武器",
  "challenge.weapon.bow": "弓",
  "challenge.weapon.wand": "法杖(短)",
  "challenge.weapon.sceptre": "权杖",
  "challenge.weapon.staff": "长杖",
  "challenge.weapon.dagger": "匕首",
  "challenge.weapon.claw": "爪",
  "challenge.weapon.oneHandSword": "单手剑",
  "challenge.weapon.twoHandSword": "双手剑",
  "challenge.weapon.oneHandAxe": "单手斧",
  "challenge.weapon.twoHandAxe": "双手斧",
  "challenge.weapon.oneHandMace": "单手锤",
  "challenge.weapon.twoHandMace": "双手锤",
  "challenge.weapon.unarmed": "徒手",
  "challenge.extra.ssf": "Solo Self-Found — 禁止与其他玩家交易",
  "challenge.extra.noDeathsUntilMaps": "通关第十章前不得死亡",
  "challenge.extra.noLifeFlask": "不得装备生命药剂",
  "challenge.extra.singleFlask": "同一时间只能装备一瓶药剂",
  "challenge.extra.maxFourLink": "主技能最多 4 连",
  "challenge.extra.noRareJewels": "禁用稀有珠宝 — 仅限魔法或更低",
  "challenge.extra.budgetOneDivine": "装备总预算：1 个神圣石",
  "challenge.extra.noLifeOnGear": "装备上不得有最大生命词缀",
  "challenge.extra.noVendorRecipes": "禁用商人配方",
  "challenge.extra.noSecondWeaponSet": "禁用第二武器组",
  "challenge.extra.noAuras": "禁用保留生命或魔力的光环",
  "challenge.extra.noMovementSpeedBoots": "鞋子不得带移动速度",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "挑战 · {{difficulty}}",
  "challenge.tagline": "{{difficulty}}挑战 · 种子 {{seed}} · {{count}} 条规则",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "{{difficulty}}挑战 · 需遵守 {{count}} 条规则",
  "challenge.seedNote": "种子 {{code}} — 分享即可让别人挑战同一套规则",
  "challenge.keystoneInstructions": "必点核心天赋。天赋树中显示为已点出 — 路径由你自己规划。",
  "challenge.treeSpecTitle": "建议路径 · {{points}} 点",
  "challenge.requiredSetup": "挑战强制要求",
  "challenge.gemNotes": "该难度不限制辅助宝石",
  "challenge.gearUniqueNotes": "强制装备 — 没有它挑战无效",
  "challenge.gearAllSlots": "所有装备栏",
  "challenge.invalidCode": "挑战代码无效：{{code}}",
  "challenge.card.ascendancy": "升华",
  "challenge.card.ascendancyNote": "由挑战抽取",
  "challenge.card.mainSkill": "主技能",
  "challenge.card.mainSkillNote": "你的全部伤害必须来自该技能",
  "challenge.card.seed": "种子",
  "challenge.card.seedNote": "相同种子，相同挑战",
  "challenge.card.keystone": "核心天赋",
  "challenge.suggestedSetup": "挑战建议",
  "challenge.treePlanTitle": "建议天赋路径",
  "challenge.treePlanNote": "已围绕你的技能规划 {{points}}/{{available}} 点：{{highlights}}。可自由改动 — 只有强制节点才是规则。",
  "challenge.gearBaseNotes": "建议基底 · {{defence}} · 需要等级 {{level}}",
  "challenge.gearBaseNotesPlain": "建议基底 · 需要等级 {{level}}",
  "challenge.stat.life": "最大生命",
  "challenge.stat.resistances": "元素抗性",
  "challenge.card.treePoints": "天赋点",
  "challenge.card.treePointsNote": "建议分配 — 只有强制节点是规则",
  "challenge.group.movement": "位移",
  "challenge.group.aura": "光环",
  "challenge.gemSuggestedNotes": "建议的辅助功能宝石 — 可随意更换",
  "challenge.gemLinksNotes": "{{count}} 个可与该技能合法连接的辅助",
  "challenge.group.main": "主连线",
  "challenge.group.guard": "守护",
  "challenge.group.curse": "诅咒",
  "challenge.gemGroupSlotNotes": "建议放在 {{slot}} — 可自由调整",
};
