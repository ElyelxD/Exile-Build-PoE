...
const ptBR: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "Desafio Aleatório",
  "challenge.subtitle": "Sorteie um conjunto de regras e monte a build",
  "challenge.rollButton": "Sortear desafio",
  ...
  "challenge.difficultyHint.easy": "Classe, ascendência e skill principal. O resto é contigo.",
  "challenge.difficultyHint.medium": "Adiciona arma obrigatória, unique obrigatório e proíbe movement skills.",
  "challenge.difficultyHint.hard": "Adiciona keystone, proíbe outros uniques e duas support gems.",
  "challenge.difficultyHint.extreme": "Tudo do Difícil mais duas regras brutais.",
  "challenge.seedLabel": "Seed",
  "challenge.seedPlaceholder": "Cole uma seed, ex: hard:8F3K22",
  "challenge.loadSeed": "Carregar seed",
  "challenge.invalidSeed": "Seed inválida. Esperado algo como hard:8F3K22.",
  "challenge.badge": "Desafio",
  "challenge.copySeed": "Copiar seed",
  "challenge.rule.class": "Jogue {{className}} — ascendência {{ascendancy}}",
  "challenge.rule.skill": "A skill principal tem de ser {{skill}}",
  "challenge.rule.level": "Chegue ao nível {{level}}",
  "challenge.rule.weapon": "Use {{weapon}}",
  "challenge.rule.unarmed": "Lute desarmado — sem arma equipada",
  "challenge.rule.unique": "Equipe {{unique}} ({{slot}})",
  "challenge.rule.keystone": "Aloque a keystone {{keystone}}",
  "challenge.rule.banMovement": "Sem movement skills (nada de Leap Slam, Dash, Flame Dash...)",
  "challenge.rule.banOtherUniques": "Nenhum item unique além de {{unique}}",
  "challenge.rule.banAllUniques": "Nenhum item unique",
  "challenge.rule.banSupports": "Support gems proibidas: {{supports}}",
  "challenge.weapon.any": "qualquer arma",
  "challenge.weapon.bow": "Arco",
  "challenge.weapon.wand": "Wand",
  "challenge.weapon.sceptre": "Sceptre",
  "challenge.weapon.staff": "Staff",
  "challenge.weapon.dagger": "Adaga",
  "challenge.weapon.claw": "Claw",
  "challenge.weapon.oneHandSword": "Espada de uma mão",
  "challenge.weapon.twoHandSword": "Espada de duas mãos",
  "challenge.weapon.oneHandAxe": "Machado de uma mão",
  "challenge.weapon.twoHandAxe": "Machado de duas mãos",
  "challenge.weapon.oneHandMace": "Maça de uma mão",
  "challenge.weapon.twoHandMace": "Maça de duas mãos",
  "challenge.weapon.unarmed": "Desarmado",
  "challenge.extra.ssf": "Solo Self-Found — sem trocas com outros jogadores",
  "challenge.extra.noDeathsUntilMaps": "Zero mortes até terminar o Ato 10",
  "challenge.extra.noLifeFlask": "Sem flasks de vida equipadas",
  "challenge.extra.singleFlask": "Apenas uma flask equipada de cada vez",
  "challenge.extra.maxFourLink": "Skill principal limitada a um 4-link",
  "challenge.extra.noRareJewels": "Sem jewels raras — apenas magic ou inferior",
  "challenge.extra.budgetOneDivine": "Orçamento total de gear: 1 Divine Orb",
  "challenge.extra.noLifeOnGear": "Nenhum modificador de Vida Máxima no gear",
  "challenge.extra.noVendorRecipes": "Sem vendor recipes",
  "challenge.extra.noSecondWeaponSet": "Sem segundo weapon set",
  "challenge.extra.noAuras": "Sem auras a reservar vida ou mana",
  "challenge.extra.noMovementSpeedBoots": "Sem Movement Speed nas botas",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "Desafio · {{difficulty}}",
  "challenge.tagline": "Desafio {{difficulty}} · seed {{seed}} · {{count}} regras",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "Desafio {{difficulty}} · {{count}} regras a cumprir",
  "challenge.seedNote": "Seed {{code}} — partilha para dar o mesmo desafio a alguém",
  "challenge.keystoneInstructions": "Keystone obrigatória. A árvore mostra-a alocada — o caminho até lá é contigo.",
  "challenge.treeSpecTitle": "Caminho sugerido · {{points}} pts",
  "challenge.requiredSetup": "Exigido pelo desafio",
  "challenge.gemNotes": "Sem restrições de support gems nesta dificuldade",
  "challenge.gearUniqueNotes": "Item obrigatório — sem ele o desafio não conta",
  "challenge.gearAllSlots": "Todos os slots",
  "challenge.invalidCode": "Código de desafio inválido: {{code}}",
  "challenge.card.ascendancy": "Ascendência",
  "challenge.card.ascendancyNote": "Sorteada pelo desafio",
  "challenge.card.mainSkill": "Skill principal",
  "challenge.card.mainSkillNote": "Todo o teu dano tem de vir desta skill",
  "challenge.card.seed": "Seed",
  "challenge.card.seedNote": "Mesma seed, mesmo desafio",
  "challenge.card.keystone": "Keystone",
  "challenge.suggestedSetup": "Sugerido pelo desafio",
  "challenge.treePlanTitle": "Caminho de passivas sugerido",
  "challenge.treePlanNote": "{{points}} de {{available}} pontos, planeados à volta da tua skill: {{highlights}}. Muda à vontade — só os nós obrigatórios são regra.",
  "challenge.gearBaseNotes": "Base sugerida · {{defence}} · requer nível {{level}}",
  "challenge.gearBaseNotesPlain": "Base sugerida · requer nível {{level}}",
  "challenge.stat.life": "Vida Máxima",
  "challenge.stat.resistances": "Resistências Elementais",
  "challenge.card.treePoints": "Pontos de passivas",
  "challenge.card.treePointsNote": "Alocação sugerida — só os nós obrigatórios são regra",
  "challenge.group.movement": "Movimento",
  "challenge.group.aura": "Aura",
  "challenge.gemSuggestedNotes": "Gem utilitária sugerida — troca à vontade",
  "challenge.gemLinksNotes": "{{count}} supports que ligam legalmente a esta skill",
  "challenge.group.main": "Links principais",
  "challenge.group.guard": "Guard",
  "challenge.group.curse": "Curse",
  "challenge.gemGroupSlotNotes": "Sugerido para {{slot}} — reorganiza à vontade",
};
