...
const fr: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "Défi Aléatoire",
  "challenge.subtitle": "Tirez un ensemble de règles et construisez-la",
  "challenge.rollButton": "Tirer un défi",
  "challenge.difficulty.easy": "Facile",
  "challenge.difficulty.medium": "Moyen",
  "challenge.difficulty.hard": "Difficile",
  "challenge.difficulty.extreme": "Extrême",
  "challenge.difficultyHint.easy": "Classe, ascendance et compétence principale. Le reste vous appartient.",
  "challenge.difficultyHint.medium": "Ajoute une arme imposée, un unique imposé et interdit les compétences de déplacement.",
  "challenge.difficultyHint.hard": "Ajoute un passif clé, interdit les autres uniques et deux gemmes de soutien.",
  "challenge.difficultyHint.extreme": "Tout le mode Difficile plus deux règles brutales.",
  "challenge.seedLabel": "Graine",
  "challenge.seedPlaceholder": "Collez une graine, ex. hard:8F3K22",
  "challenge.loadSeed": "Charger la graine",
  "challenge.invalidSeed": "Graine invalide. Format attendu : hard:8F3K22.",
  "challenge.badge": "Défi",
  "challenge.copySeed": "Copier la graine",
  "challenge.rule.class": "Jouez {{className}} — ascendance {{ascendancy}}",
  "challenge.rule.skill": "La compétence principale doit être {{skill}}",
  "challenge.rule.level": "Atteignez le niveau {{level}}",
  "challenge.rule.weapon": "Utilisez {{weapon}}",
  "challenge.rule.unarmed": "Combattez à mains nues — aucune arme équipée",
  "challenge.rule.unique": "Équipez {{unique}} ({{slot}})",
  "challenge.rule.keystone": "Allouez le passif clé {{keystone}}",
  "challenge.rule.banMovement": "Aucune compétence de déplacement (ni Leap Slam, Dash, Flame Dash...)",
  "challenge.rule.banOtherUniques": "Aucun objet unique hormis {{unique}}",
  "challenge.rule.banAllUniques": "Aucun objet unique",
  "challenge.rule.banSupports": "Gemmes de soutien interdites : {{supports}}",
  "challenge.weapon.any": "n'importe quelle arme",
  "challenge.weapon.bow": "Arc",
  "challenge.weapon.wand": "Baguette",
  "challenge.weapon.sceptre": "Sceptre",
  "challenge.weapon.staff": "Bâton",
  "challenge.weapon.dagger": "Dague",
  "challenge.weapon.claw": "Griffe",
  "challenge.weapon.oneHandSword": "Épée à une main",
  "challenge.weapon.twoHandSword": "Épée à deux mains",
  "challenge.weapon.oneHandAxe": "Hache à une main",
  "challenge.weapon.twoHandAxe": "Hache à deux mains",
  "challenge.weapon.oneHandMace": "Masse à une main",
  "challenge.weapon.twoHandMace": "Masse à deux mains",
  "challenge.weapon.unarmed": "Mains nues",
  "challenge.extra.ssf": "Solo Self-Found — aucun échange avec d'autres joueurs",
  "challenge.extra.noDeathsUntilMaps": "Zéro mort jusqu'à la fin de l'Acte 10",
  "challenge.extra.noLifeFlask": "Aucun flacon de vie équipé",
  "challenge.extra.singleFlask": "Un seul flacon équipé à la fois",
  "challenge.extra.maxFourLink": "Compétence principale limitée à un 4-liens",
  "challenge.extra.noRareJewels": "Aucun joyau rare — magique ou moins uniquement",
  "challenge.extra.budgetOneDivine": "Budget total d'équipement : 1 Divine Orb",
  "challenge.extra.noLifeOnGear": "Aucun modificateur de Vie maximum sur l'équipement",
  "challenge.extra.noVendorRecipes": "Aucune recette de marchand",
  "challenge.extra.noSecondWeaponSet": "Pas de second set d'armes",
  "challenge.extra.noAuras": "Aucune aura réservant vie ou mana",
  "challenge.extra.noMovementSpeedBoots": "Aucune vitesse de déplacement sur les bottes",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "Défi · {{difficulty}}",
  "challenge.tagline": "Défi {{difficulty}} · graine {{seed}} · {{count}} règles",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "Défi {{difficulty}} · {{count}} règles à respecter",
  "challenge.seedNote": "Graine {{code}} — partagez-la pour proposer le même défi",
  "challenge.keystoneInstructions": "Passif clé obligatoire. L'arbre l'affiche alloué — le chemin, c'est vous qui le planifiez.",
  "challenge.treeSpecTitle": "Chemin suggéré · {{points}} pts",
  "challenge.requiredSetup": "Imposé par le défi",
  "challenge.gemNotes": "Aucune restriction de gemme de soutien à cette difficulté",
  "challenge.gearUniqueNotes": "Objet obligatoire — sans lui le défi ne compte pas",
  "challenge.gearAllSlots": "Tous les emplacements",
  "challenge.invalidCode": "Code de défi invalide : {{code}}",
  "challenge.card.ascendancy": "Ascendance",
  "challenge.card.ascendancyNote": "Tirée par le défi",
  "challenge.card.mainSkill": "Compétence principale",
  "challenge.card.mainSkillNote": "Tous vos dégâts doivent venir de cette compétence",
  "challenge.card.seed": "Graine",
  "challenge.card.seedNote": "Même graine, même défi",
  "challenge.card.keystone": "Passif clé",
  "challenge.suggestedSetup": "Suggéré par le défi",
  "challenge.treePlanTitle": "Chemin de passifs suggéré",
  "challenge.treePlanNote": "{{points}} points sur {{available}}, planifiés autour de votre compétence : {{highlights}}. Modifiez librement — seuls les nœuds imposés font règle.",
  "challenge.gearBaseNotes": "Base suggérée · {{defence}} · niveau {{level}} requis",
  "challenge.gearBaseNotesPlain": "Base suggérée · niveau {{level}} requis",
  "challenge.stat.life": "Vie maximum",
  "challenge.stat.resistances": "Résistances élémentaires",
  "challenge.card.treePoints": "Points de passifs",
  "challenge.card.treePointsNote": "Allocation suggérée — seuls les nœuds imposés font règle",
  "challenge.group.movement": "Déplacement",
  "challenge.group.aura": "Aura",
  "challenge.gemSuggestedNotes": "Gemme utilitaire suggérée — changez-la librement",
  "challenge.gemLinksNotes": "{{count}} soutiens qui se lient légalement à cette compétence",
  "challenge.group.main": "Liens principaux",
  "challenge.group.guard": "Garde",
  "challenge.group.curse": "Malédiction",
  "challenge.gemGroupSlotNotes": "Suggéré pour {{slot}} — réorganisez librement",
};
