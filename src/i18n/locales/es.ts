...
const es: Record<TranslationKey, string> = {
  ...
  // ── Challenge mode ──
  "challenge.heading": "Desafío Aleatorio",
  "challenge.subtitle": "Sortea un conjunto de reglas y móntala tú",
  "challenge.rollButton": "Sortear desafío",
  ...
  "challenge.difficultyHint.easy": "Clase, ascendencia y habilidad principal. El resto es cosa tuya.",
  "challenge.difficultyHint.medium": "Añade arma obligatoria, único obligatorio y prohíbe habilidades de movimiento.",
  "challenge.difficultyHint.hard": "Añade una piedra angular, prohíbe los demás únicos y dos gemas de soporte.",
  "challenge.difficultyHint.extreme": "Todo lo de Difícil más dos reglas brutales.",
  "challenge.seedLabel": "Semilla",
  "challenge.seedPlaceholder": "Pega una semilla, ej. hard:8F3K22",
  "challenge.loadSeed": "Cargar semilla",
  "challenge.invalidSeed": "Semilla inválida. Se espera algo como hard:8F3K22.",
  "challenge.badge": "Desafío",
  "challenge.copySeed": "Copiar semilla",
  "challenge.rule.class": "Juega {{className}} — ascendencia {{ascendancy}}",
  "challenge.rule.skill": "La habilidad principal debe ser {{skill}}",
  "challenge.rule.level": "Alcanza el nivel {{level}}",
  "challenge.rule.weapon": "Usa {{weapon}}",
  "challenge.rule.unarmed": "Lucha desarmado — sin arma equipada",
  "challenge.rule.unique": "Equipa {{unique}} ({{slot}})",
  "challenge.rule.keystone": "Asigna la piedra angular {{keystone}}",
  "challenge.rule.banMovement": "Sin habilidades de movimiento (nada de Leap Slam, Dash, Flame Dash...)",
  "challenge.rule.banOtherUniques": "Ningún objeto único aparte de {{unique}}",
  "challenge.rule.banAllUniques": "Ningún objeto único",
  "challenge.rule.banSupports": "Gemas de soporte prohibidas: {{supports}}",
  "challenge.weapon.any": "cualquier arma",
  "challenge.weapon.bow": "Arco",
  "challenge.weapon.wand": "Varita",
  "challenge.weapon.sceptre": "Cetro",
  "challenge.weapon.staff": "Bastón",
  "challenge.weapon.dagger": "Daga",
  "challenge.weapon.claw": "Garra",
  "challenge.weapon.oneHandSword": "Espada a una mano",
  "challenge.weapon.twoHandSword": "Espada a dos manos",
  "challenge.weapon.oneHandAxe": "Hacha a una mano",
  "challenge.weapon.twoHandAxe": "Hacha a dos manos",
  "challenge.weapon.oneHandMace": "Maza a una mano",
  "challenge.weapon.twoHandMace": "Maza a dos manos",
  "challenge.weapon.unarmed": "Desarmado",
  "challenge.extra.ssf": "Solo Self-Found — sin comerciar con otros jugadores",
  "challenge.extra.noDeathsUntilMaps": "Cero muertes hasta terminar el Acto 10",
  "challenge.extra.noLifeFlask": "Sin frascos de vida equipados",
  "challenge.extra.singleFlask": "Solo un frasco equipado a la vez",
  "challenge.extra.maxFourLink": "Habilidad principal limitada a un 4-link",
  "challenge.extra.noRareJewels": "Sin joyas raras — solo mágicas o peores",
  "challenge.extra.budgetOneDivine": "Presupuesto total de equipo: 1 Divine Orb",
  "challenge.extra.noLifeOnGear": "Ningún modificador de Vida Máxima en el equipo",
  "challenge.extra.noVendorRecipes": "Sin recetas de vendedor",
  "challenge.extra.noSecondWeaponSet": "Sin segundo conjunto de armas",
  "challenge.extra.noAuras": "Sin auras que reserven vida o maná",
  "challenge.extra.noMovementSpeedBoots": "Sin Velocidad de Movimiento en las botas",
  "challenge.buildName": "{{skill}} {{ascendancy}}",
  "challenge.leagueLabel": "Desafío · {{difficulty}}",
  "challenge.tagline": "Desafío {{difficulty}} · semilla {{seed}} · {{count}} reglas",
  "challenge.playstyle": "{{skill}} · {{ascendancy}}",
  "challenge.stageTitle": "{{skill}} {{ascendancy}}",
  "challenge.stageSummary": "Desafío {{difficulty}} · {{count}} reglas que cumplir",
  "challenge.seedNote": "Semilla {{code}} — compártela para dar el mismo desafío a alguien",
  "challenge.keystoneInstructions": "Piedra angular obligatoria. El árbol la muestra asignada — el camino lo planeas tú.",
  "challenge.treeSpecTitle": "Ruta sugerida · {{points}} pts",
  "challenge.requiredSetup": "Exigido por el desafío",
  "challenge.gemNotes": "Sin restricciones de gemas de soporte en esta dificultad",
  "challenge.gearUniqueNotes": "Objeto obligatorio — sin él el desafío no cuenta",
  "challenge.gearAllSlots": "Todas las ranuras",
  "challenge.invalidCode": "Código de desafío inválido: {{code}}",
  "challenge.card.ascendancy": "Ascendencia",
  "challenge.card.ascendancyNote": "Sorteada por el desafío",
  "challenge.card.mainSkill": "Habilidad principal",
  "challenge.card.mainSkillNote": "Todo tu daño debe venir de esta habilidad",
  "challenge.card.seed": "Semilla",
  "challenge.card.seedNote": "Misma semilla, mismo desafío",
  "challenge.card.keystone": "Piedra angular",
  "challenge.suggestedSetup": "Sugerido por el desafío",
  "challenge.treePlanTitle": "Ruta de pasivas sugerida",
  "challenge.treePlanNote": "{{points}} de {{available}} puntos, planificados en torno a tu habilidad: {{highlights}}. Cámbialo libremente — solo los nodos obligatorios son regla.",
  "challenge.gearBaseNotes": "Base sugerida · {{defence}} · requiere nivel {{level}}",
  "challenge.gearBaseNotesPlain": "Base sugerida · requiere nivel {{level}}",
  "challenge.stat.life": "Vida Máxima",
  "challenge.stat.resistances": "Resistencias Elementales",
  "challenge.card.treePoints": "Puntos de pasivas",
  "challenge.card.treePointsNote": "Asignación sugerida — solo los nodos obligatorios son regla",
  "challenge.group.movement": "Movimiento",
  "challenge.group.aura": "Aura",
  "challenge.gemSuggestedNotes": "Gema de utilidad sugerida — cámbiala libremente",
  "challenge.gemLinksNotes": "{{count}} soportes que enlazan legalmente con esta habilidad",
  "challenge.group.main": "Enlaces principales",
  "challenge.group.guard": "Guardia",
  "challenge.group.curse": "Maldición",
  "challenge.gemGroupSlotNotes": "Sugerido para {{slot}} — reorganiza libremente",
};
